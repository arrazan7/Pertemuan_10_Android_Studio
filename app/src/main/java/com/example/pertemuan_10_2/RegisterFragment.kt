...
class RegisterFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        btnRegister.setOnClickListener{
            LoginActivity.EXTRA_USERNAME = username.text.toString()
            LoginActivity.EXTRA_EMAIL = email.text.toString()
            LoginActivity.EXTRA_PHONE = phone.text.toString()
            LoginActivity.EXTRA_PASSWORD = password.text.toString()
